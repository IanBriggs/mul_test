...
void print_flt_vectors(const flt_mat *const in, char * label);
void fprint_flt_vectors(FILE * stream, const flt_mat *const in, char * label);
void save_flt_vectors(char * filename, const flt_mat *const in, char * label);
